...
{
    public Transform objectTransform = default;
    private Vector3 _orignalPosOfObj = default;
    ...
    void Start()
    {
        ...
        _orignalPosOfObj = objectTransform.position;
    }
    ...
    public void CameraShakes()
    {
        ...
        objectTransform.localPosition = _orignalPosOfObj + Random.insideUnitSphere * shakeFrequency;
    }
    ...
    public void StopShake()
    {
        ...
        objectTransform.localPosition = _orignalPosOfObj;
    }
}
